        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-[#b60808]/5 to-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center text-gray-800 mb-3">Accountable Leadership</h3>
              <p className="text-gray-600 text-center">
                To nurture and promote accountable leadership and good governance at the grassroots level.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#fe0000]/5 to-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center text-gray-800 mb-3">Social and Economic Inclusion</h3>
              <p className="text-gray-600 text-center">
                To eliminate social and economic marginalization in Likuyani and surrounding areas.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#03ac56]/5 to-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center text-gray-800 mb-3">Community-Driven Empowerment</h3>
              <p className="text-gray-600 text-center">
                To create a replicable model of community-driven empowerment rooted in local solutions.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#9ed462]/5 to-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center text-gray-800 mb-3">Empowering Youth and Women</h3>
              <p className="text-gray-600 text-center">
                To empower youth and women as development champions through leadership, innovation, and entrepreneurship.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#b60808]/5 to-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center text-gray-800 mb-3">Climate-Resilient Livelihoods</h3>
              <p className="text-gray-600 text-center">
                To advance climate-resilient livelihoods and environmental protection.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#fe0000]/5 to-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center text-gray-800 mb-3">Partnerships for Transformation</h3>
              <p className="text-gray-600 text-center">
                To build lasting partnerships that support inclusive and sustainable community transformation.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-gradient-to-br from-[#b60808]/5 to-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center text-gray-800 mb-3">Empowerment</h3>
              <p className="text-gray-600 text-center">
                Strengthening community voices and capabilities.
              </p>
            </div>
...
<h3 className="text-xl font-bold text-center text-gray-800 mb-3">Equity</h3>
<p className="text-gray-600 text-center">
Ensuring fairness, inclusion, and justice for all.
</p>
</div>
        ...
        <div className="bg-gradient-to-br from-[#9ed462]/5 to-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
          ...
          <h3 className="text-xl font-bold text-center text-gray-800 mb-3">Leadership & Governance</h3>
          <p className="text-gray-600 text-center">
            Promoting civic responsibility, participation, and strong local governance systems.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#b60808]/5 to-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
          ...
          <h3 className="text-xl font-bold text-center text-gray-800 mb-3">Sustainability</h3>
          <p className="text-gray-600 text-center">
            Designing long-term solutions for current and future generations.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#fe0000]/5 to-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
          ...
          <h3 className="text-xl font-bold text-center text-gray-800 mb-3">Collaboration</h3>
          <p className="text-gray-600 text-center">
            Fostering unity and working together for maximum impact.
          </p>
        </div>
      </div>
    </div>
