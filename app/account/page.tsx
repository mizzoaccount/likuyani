  ...
  if (isLoading || !user) {
    return (
      <div className="bg-white min-h-screen flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#03ac56]"></div>
      </div>
    );
  }
    ...
    <div className="bg-white min-h-screen">
      ...
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white rounded-xl border border-[#03ac56] shadow-sm p-6"
        >
          {activeTab === "profile" && (
            <div>
              <div className="flex justify-between items-center mb-6">
                ...
                {!isEditing ? (
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-[#03ac56] hover:bg-[#03ac56] text-black font-bold rounded-full transition-colors"
                  >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#03ac56] hover:bg-[#03ac56] text-black font-bold rounded-full transition-colors"
                    >
                      Save Changes
                    </button>
                  </div>
            ...
            <div>
             ...
             {/*} {isLoadingOrders ? (
                <div className="flex justify-center items-center py-10">
                  <div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-[#03ac56]"></div>
                </div>
              ) : orders.length > 0 ? (
                ...
                <div className="text-center py-10">
                  ...
                  <button
                    ...
                    className="mt-4 px-4 py-2 bg-[#03ac56] hover:bg-[#03ac56] text-black font-bold rounded-full transition-colors"
                  >
                    Start Shopping
                  </button>
                </div>
